...
<span id="save_obs"></span>

<script>
    function save_obs_data() {
        var observaciones = document.getElementById('observaciones').value;
        var dataen = 'observaciones=' + observaciones + '&cod_estudiante=' + '<?php echo $_POST['cod_estudiante']; ?>';
        $.ajax({
            type: 'POST',
            url: 'share/save_observacion.php',
            data: dataen,
    ...
    function hide_up() {
        document.getElementById('btn_saved_cont').style.display = "block";
    }

    function none_up() {
        document.getElementById('btn_saved_cont').style.display = "none";
    }
</script>
<?php
...
?>
    ...
    <div class="pas_card_left cord_left animation-right">
        <div class="container_card_1">
            ...
            <div class="inputs_cont">
                <form method="post">
                    ...
                    <div class="box_input">
                        <input class="text_inp" disabled value="<?php echo $data_consult_sql_marcaje['grado']; ?>" type="text" name="1" id="1" placeholder="Grado">
                    </div>
                    <div class="box_input">
        ...
        <div class="container_card_1 cord_top">
            ...
            <div class="inputs_cont">
                <form method="post">
                    <div class="box_input">
                        <textarea name="observaciones" onchange="hide_up();" id="observaciones" class="textarea_observaciones" placeholder="Dijita una observacion"><?php echo $data_consult_sql_marcaje['observacion']; ?> 
                    </textarea>
                    </div>
                </form>
            </div>
        </div>
        <div class="container_card_1 cord_top" id="btn_saved_cont" style="display:none;">
            <div class="content_button_save">
                <button class="btn_saved_2" onclick="save_obs_data();">Guardar Observacion<i style="margin-left: 10px;" class="fa-solid fa-floppy-disk"></i></button>
            </div>
        </div>

    </div>

<?php } elseif (empty($cod_estudiante)) {
?>
    ...
    <div class="pas_card_left cord_left animation-right">
        ...
        <div class="container_card_1 cord_top">
            ...
            <div class="inputs_cont">
                <form method="post">
                    <div class="box_input">
                        <textarea disabled name="observaciones" id="observaciones" class="textarea_observaciones" placeholder="Dijita una observacion"><?php echo $data_consult_sql_marcaje['observacion']; ?></textarea>
                    </div>
                </form>
            </div>
        </div>
        <div class="container_card_1 cord_top" id="btn_saved_cont" style="display:none;">
            <div class="content_button_save">
                <button class="btn_saved_2" onclick="">Guardar Observacion<i style="margin-left: 10px;" class="fa-solid fa-floppy-disk"></i></button>
            </div>
        </div>
...
if(mysqli_num_rows($res_consult_sql_marcaje) <= 0 and $cod_estudiante > 0){
    ?>
    <script>
