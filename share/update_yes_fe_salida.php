...
$actualizar_fecha_entrada = "UPDATE historial_fecha SET fecha_salida = '" . $fecha_con_horas_minutos . "', pm_am_salida = '".$pm_am_entrada."' WHERE id_alumno = '" . $id_alumno . "' and dia_fecha = '" . $fecha_dia_mes_a . "'";
...
<script>
    ...
    'Reemplazado!',
    'Se actualizo la fecha de salida de el dia <?php echo $data_history_converse_2['dia_fecha']; ?> ',
    'success'
    )
